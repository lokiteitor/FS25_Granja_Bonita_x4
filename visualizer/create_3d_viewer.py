...
def main():
    ...
    sys.path.insert(0, os.path.join(project_root, "dem_generator"))
    from generate_dem import DEM_NAME
    input_path = os.path.join(project_root, "dem_generator", DEM_NAME)
...
{soil_legend_html}
    ...
    <script>
        ...
        // Deliberately far above human speed: the canvas is kilometres wide and waiting is worse
        // than losing realism.
        ...
        function buildTerrainMesh(res) {{
            ...
            for (let i = 0; i < count; i++) {{
                ...
                // Map x,z (-half to +half of the canvas) to u,v (0 to 1)
                const u = (x + MAP_SIZE / 2) / MAP_SIZE;
